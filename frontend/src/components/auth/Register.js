...
class Register extends Component {
  ...
  languages = {
    ...
    Spanish: {
      securityQuestion: 'Escoge tu pregunta de seguridad',
      answer: 'Respuesta',
      ...
      resendPin: 'Renviar el código de acceso',
      verify: 'Verifique su correo',
      skip: 'Saltar la verificación'
    },
    French: {
      ...
      resendPin: 'Renvoyer PIN',
      verify: 'Vérifier courrier électronique',
      skip: 'Ignorer vérification'
    },
    Portuguese: {
      ...
      logIn: 'Acessar',
      pin: 'PIN (código de acceso)',
      resendPin: 'Reenviar código de acceso',
      verify: 'Verificar email',
      skip: 'Ignorar a verificação'
    }
  }
