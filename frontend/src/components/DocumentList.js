      ...
      <Table>
        <tbody>
          ...
          {this.props.documents
            ? this.state.expanded ? this.props.documents.map(document => (
                <DocumentListItem
                  document={document}
              ...
              : this.props.documents.slice(0,this.state.showLess).map(document => (
                <DocumentListItem
                  document={document}
                  docClass={document.docClass}
                  fileName={document.fileName}
              ...
              ? this.props.documents.length > this.state.showLess
                ? <tr className='text-centered'>
                    <td colSpan="5" id="buttonRowData">
                      {this.state.expanded
                        ? <button className={'expandButton ' + this.props.status + 'Color'} onClick={this.toggleExpand}>
