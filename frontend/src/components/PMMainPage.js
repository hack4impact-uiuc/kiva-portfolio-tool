...
export class PMMainPage extends Component {
  ...
  languages = {
    ...
    Spanish: {
      addFP: 'Añadir un nuevo socio',
      orgName: 'Nombre de la organización:',
      enterOrgName: 'Escribe el nombre del socio aquí...',
      email: 'Correo Electronico:',
      enterEmail: 'Escribe el correo electrónico del socio aquí...',
      create: 'Crear',
      confirm:
        'Estás seguro que quieres reiniciar el proceso?  Esto borrará todos los documentos asociados con este socio.',
      exit: 'Salida',
      view: 'Visualizar el panel de control',
      restart: 'Reiniciar el proceso',
      add: 'Añadir nuevo',
      inProcess: 'En proceso',
      newPartner: 'Nuevo socio',
      complete: 'Completado',
      search: 'Busque por un socio...',
      fieldPartners: 'Socios'
    },
    French: {
      addFP: 'Ajouter un nouveau partenaire',
      orgName: 'Nom de votre organization:',
      enterOrgName: 'Écrire le nom du partenaire ici...',
      email: 'Courrier électronique:',
      enterEmail: 'Écrire le courrier électronique du partenaire ici...',
      create: 'Créer',
      confirm:
        'Êtes-vous sur de vouloir redémarrer le processus? Cela supprimera tous les documents associés à ce partenaire.',
      exit: 'Sortie',
      view: 'Visualiser tableau de bord',
      restart: 'Redémarrer processus',
      add: 'Ajouter nouveau',
      inProcess: 'En cours',
      newPartner: 'Nouveau partenaire',
      complete: 'Complet',
      search: 'Rechercher un partenaire...',
      fieldPartners: 'Partenaires'
    },
    Portuguese: {
      addFP: 'Adicionar novo Parceiro',
      orgName: 'Nome da Instituição:',
      enterOrgName: 'Inserir o nome da Instituição Parceira aqui...',
      email: 'Email:',
      enterEmail: 'Inserir o email da Instituição Parceira aqui...',
      create: 'Criar',
      confirm:
        'Você tem certeza que quer reiniciar o processo? Isto apagará todos os documentos relacionados a este Parceiro.',
      exit: 'Sair',
      view: 'Visualizar painel de controle',
      restart: 'Reiniciar processo',
      add: 'Adicionar novo Parceiro',
      inProcess: 'Em processo',
      newPartner: 'Novo parceiro',
      complete: 'Completo',
      search: 'Buscar por um Parceito....',
      fieldPartners: 'Instituições Parceiras'
    }
  }
